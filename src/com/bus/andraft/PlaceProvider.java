...
public class PlaceProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.bus.andraft.PlaceProvider";
	...
	private boolean establish = false;

	// Obtain browser key from https://code.google.com/apis/console
	String mKey = "key=AIzaSyDF0ZPnlHQJFwjf5J_Z0wk2wW9ggrjX6YE";
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		JsonParsePlace parser = new JsonParsePlace();
		PlaceDetailParser detailsParser = new PlaceDetailParser();
		...
		case SUGGESTIONS:
			...
			try {
				// Parse the places ( JSON => List )
				list = parser.parse(new JSONObject(jsonString));
				if (parser.getStatus().equals("ZERO_RESULTS")){
					establish = true;
					jsonString = getPlaces(selectionArgs);
					list = parser.parse(new JSONObject(jsonString));
					}
